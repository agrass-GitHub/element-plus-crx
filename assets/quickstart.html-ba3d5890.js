...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>组件源码是用 Typescript 编写，如果你用的不是官方 vite 脚手架创建的vue3 项目，则需要考虑添加 typescript 支持。</p></div>`,13);function m(v,b){const s=e("ExternalLinkIcon");return t(),p("div",null,[u,n("p",null,[n("a",r,[d,o(s)])]),k])}const f=a(l,[["render",m],["__file","quickstart.html.vue"]]);export{f as default};
